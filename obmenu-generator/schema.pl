...
our $SCHEMA = [
    ...
    {item => ['chrome http://',  'Web Browser',       'web-browser']},
    ...
    {begin_cat => ['Advanced Settings', 'gnome-settings']},
        ...
        {begin_cat => ['Obmenu-Generator', 'menu-editor']},
            ...
            {sep  => undef},
            {item => ['obmenu-generator -p',       'Generate a dynamic menu',           'menu-editor']},
            {item => ['obmenu-generator -p -i',    'Generate a dynamic menu with icons','menu-editor']},
            {sep  => undef},
