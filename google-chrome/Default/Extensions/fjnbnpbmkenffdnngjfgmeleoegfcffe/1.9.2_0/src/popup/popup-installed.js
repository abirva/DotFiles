...
function renderAllSwitch() {
    if (!isDisabledAll()) {
        ...
        document.getElementById('stylish_on').style.display = "block";
        ...
        document.getElementById('stylish_off').style.display = "block";
...
function bindHandlers(el, style) {
    ...
    el.querySelector(".thumbnail_feedback").addEventListener('click', onFeedbackStyleClick(style));
}
...
function onActivateClick(style) {
    return function (e) {
        ...
        analyticsEvent("Installed_styles_menu", "enable", style.styleId);
    };
}
...
function onDeactivateClick(style) {
    return function (e) {
        ...
        analyticsEvent("Installed_styles_menu", "disable", style.styleId);
    }
}
...
function onDeleteStyleClick(style) {
    return function (e) {
        ...
        analyticsEvent("Installed_styles_menu", "delete", style.styleId);
    }
}
